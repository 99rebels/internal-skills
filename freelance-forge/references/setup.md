...
```bash
python3 -c "import sys; sys.path.insert(0, '$HOME/.freelance-forge/shared'); import db_helper; print(db_helper.paths())"
```

This should print the config directory, shared directory, and database path. If it fails, something went wrong in Steps 2-4 — troubleshoot.
